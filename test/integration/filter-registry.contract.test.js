...
const IGNORED_UPSTREAM = [
  ...
  ['spells', { search: 'fireball' }],
  ['creatures', { cr: 5 }],
  ['creatures', { challenge_rating_decimal: 5 }],
  ...
  ['magicitems', { rarity__key: 'very-rare' }],
  ['magicitems', { document__gamesystem__key: '5e-2014' }],
  ['rules', { search: 'grapple' }],
  ['rules', { desc__icontains: 'grapple' }],
  ['classes', { name__icontains: 'bard' }],
  ['classes', { subclass_of__key: 'srd_bard' }],
  ['classes', { subclass_of__isnull: true }],
  ['species', { subspecies_of: 'srd_halfling' }],
  ['species', { search: 'elf' }],
  ['feats', { search: 'alert' }],
